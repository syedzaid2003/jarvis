...
def check_internet_speed():
    ...
    st.get_servers()  # Get a list of speedtest.net servers
    st.get_best_server()  # Get the best server based on ping
    st.download()  # Perform download speed test
    st.upload()  # Perform upload speed test
    st.results.share()  # Share the results (optional)
    results_dict = st.results.dict  # Get the results as a dictionary
    download_speed = results_dict["download"] / 10**6  # Convert to Mbps
    upload_speed = results_dict["upload"] / 10**6  # Convert to Mbps
    ping = results_dict["ping"]  # Get the ping in ms
            ...
            while True:
              ...
              ####################################################################
                    ...
                    while True:
                        ...
                        if teacher_query == "":
                            continue
                        if teacher_query.lower() == "exit jarvis":
                ...
                elif "what is your developer details" in query:
                    speak("My developer is syed zaid. He created me to assist with various tasks and make life easier.")
